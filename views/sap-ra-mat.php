...
<head>
    ...
    <meta name="description" content="Danh sách truyện tranh sắp ra mắt tại MANGA18K. Đọc manga, manhwa, manhua miễn phí.">
    <meta property="og:title" content="MANGA18K - Danh Sách Truyện Sắp Ra Mắt">
    <meta property="og:description" content="Danh sách truyện tranh sắp ra mắt tại MANGA18K. Đọc manga, manhwa, manhua miễn phí.">
    <meta property="og:image" content="https://www.truyentranhnet.com/img/logo.png">
    <meta property="og:url" content="https://www.truyentranhnet.com/sap-ra-mat">
    <meta name="robots" content="index, follow">
    <link href="../img/logo.png" rel="icon">
    <title>MANGA18K - Danh Sách Truyện Sắp Ra Mắt</title>
...
<body class="bg-gray-900 text-white font-poppins">
    ...
    <div class="container mx-auto px-4 py-8 pt-16">
        <h4 class="text-2xl font-semibold mb-6 text-center"><i class="fas fa-clock"></i> DANH SÁCH TRUYỆN SẮP RA MẮT</h4>
        ...
        <nav aria-label="Page navigation" class="mt-4">
            <ul class="pagination">
                ...
                <li class="page-item <?= ($page <= 1) ? 'disabled' : '' ?>">
                    <a class="page-link" href="sap-ra-mat.php?page=<?= $page - 1 ?>" aria-label="Previous">
                ...
                <?php if ($page > 3): ?>
                    <li class="page-item">
                        <a class="page-link" href="sap-ra-mat.php?page=1">1</a>
                    </li>
                    <?php if ($page > 4): ?>
                ...
                <?php for ($i = $startPage; $i <= $endPage; $i++): ?>
                    <li class="page-item <?= ($i == $page) ? 'active' : '' ?>">
                        <a class="page-link" href="sap-ra-mat.php?page=<?= $i ?>"><?= $i ?></a>
                    </li>
                <?php endfor; ?>
                ...
                <?php if ($page < $totalPages - 2): ?>
                    ...
                    <?php endif; ?>
                    <li class="page-item">
                        <a class="page-link" href="sap-ra-mat.php?page=<?= $totalPages ?>"><?= $totalPages ?></a>
                    </li>
                <?php endif; ?>

                <!-- Nút Next -->
                <li class="page-item <?= ($page >= $totalPages) ? 'disabled' : '' ?>">
                    <a class="page-link" href="sap-ra-mat.php?page=<?= $page + 1 ?>" aria-label="Next">
