...
<body class="bg-gray-900 text-white font-poppins">
    ...
    <div class="container mx-auto px-4 py-8 pt-16">
        <h4 class="text-2xl font-semibold mb-6 text-center"><i class="fas fa-book"></i> DANH SÁCH TRUYỆN MỚI</h4>
        ...
        <nav aria-label="Page navigation" class="mt-4">
            <ul class="pagination">
                ...
                <li class="page-item <?= ($page <= 1) ? 'disabled' : '' ?>">
                    <a class="page-link" href="truyen-moi.php?page=<?= $page - 1 ?>" aria-label="Previous">
                ...
                <?php if ($page > 3): ?>
                    <li class="page-item">
                        <a class="page-link" href="truyen-moi.php?page=1">1</a>
                    </li>
                    <?php if ($page > 4): ?>
                ...
                <?php for ($i = $startPage; $i <= $endPage; $i++): ?>
                    <li class="page-item <?= ($i == $page) ? 'active' : '' ?>">
                        <a class="page-link" href="truyen-moi.php?page=<?= $i ?>"><?= $i ?></a>
                    </li>
                <?php endfor; ?>
                ...
                <?php if ($page < $totalPages - 2): ?>
                    ...
                    <?php endif; ?>
                    <li class="page-item">
                        <a class="page-link" href="truyen-moi.php?page=<?= $totalPages ?>"><?= $totalPages ?></a>
                    </li>
                <?php endif; ?>

                <!-- Nút Next -->
                <li class="page-item <?= ($page >= $totalPages) ? 'disabled' : '' ?>">
                    <a class="page-link" href="truyen-moi.php?page=<?= $page + 1 ?>" aria-label="Next">
